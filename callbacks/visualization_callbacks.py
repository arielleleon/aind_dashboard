...
from callbacks.shared_callback_utils import (
    Input, Output, State, callback, ALL,
    app_utils, subject_timeseries, subject_percentile_timeseries, percentile_heatmap,
...
def update_timeseries_plot(timeseries_data, selected_features, n_clicks_list, scroll_state, card_ids):
    ...
    """
    highlighted_session = extract_highlighted_session(n_clicks_list, scroll_state, card_ids)
