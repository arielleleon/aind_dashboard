...
class AppContent:
    ...
    def build(self):
        ...
        return html.Div([
            ...
            dcc.Interval(id="resize-interval", interval=1000, n_intervals=0, max_intervals=1),  # Trigger initial calculation
            dcc.Store(id="resize-trigger", data=None)  # Store for window resize events
