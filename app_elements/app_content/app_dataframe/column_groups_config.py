...
COLUMN_GROUPS = {
    'core': {
        ...
        'icon': 'fas fa-star',
        'columns': [
            'subject_id', 'session_date', 'session', 'PI', 
            'trainer', 'rig', 'water_day_total', 
            'total_trials', 'finished_trials', 'ignore_rate',
    ...
    'alerts': {
        ...
        'columns': [
            'strata_abbr', 'combined_alert', 'percentile_category',
            'threshold_alert', 'total_sessions_alert', 
    ...
    'processed_features': {
        ...
        'columns': [
            ...
            'finished_trials_processed', 'ignore_rate_processed',
            'total_trials_processed', 'foraging_performance_processed',
    ...
    'weight_water': {
        ...
        'icon': 'fas fa-tint',
        'columns': [
            'base_weight', 'target_weight', 'target_weight_ratio',
            'weight_after', 'weight_after_ratio',
            'water_in_session_foraging', 'water_in_session_manual', 
            'water_in_session_total', 'water_after_session'
        ]
    },
    'behavioral_details': {
    ...
    'autowater': {
        ...
        'icon': 'fas fa-faucet',
        'columns': [
            'total_trials_with_autowater', 'finished_trials_with_autowater',
            'finished_rate_with_autowater', 'ignore_rate_with_autowater',
            'autowater_collected', 'autowater_ignored', 'water_day_total_last_session', 
...
def get_default_visible_columns():
    """Get default visible columns (core + alerts)"""
    visible = []
