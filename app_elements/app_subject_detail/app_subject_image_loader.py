...
class AppSubjectImageLoader:
    ...
    def get_s3_public_url(
        ...
        result_path="foraging_nwb_bonsai_processed",
        bucket_name="aind-behavior-data",
    ):
        """
        Generate a public S3 URL for accessing a specific figure
        """
        logger.info(
            f"Building S3 URL: subject={subject_id}, date={session_date}, nwb_suffix={nwb_suffix}, figure={figure_suffix}"
        )
